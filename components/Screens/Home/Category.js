...
const Category = ({ name }) => {
    ...
    if (name.toLowerCase() === 'starters' || name.toLowerCase() === 'desserts' || name.toLowerCase() === 'breakfast' || name.toLowerCase() === 'beef' || name.toLowerCase() === 'chicken' || name.toLowerCase() === 'pork' || name.toLowerCase() === 'seafood' || name.toLowerCase() === 'vegetarian' || name.toLowerCase() === 'miscellaneous' || name.toLowerCase() === 'goat' || name.toLowerCase() === 'pasta' || name.toLowerCase() === 'side' || name.toLowerCase() === 'vegan') {
        return (
